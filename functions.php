...
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">Full Legal Name (as shown on tax return) <span style="color:#ef4444;">*</span></label>
<input type="text" name="affwp_w9_legal_name" required style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
</p>

<p style="margin-bottom:1rem;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">Business Name (if different from above)</label>
<input type="text" name="affwp_w9_business_name" style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
</p>

<p style="margin-bottom:1rem;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">Federal Tax Classification <span style="color:#ef4444;">*</span></label>
<select name="affwp_w9_tax_classification" required style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
...
<p style="margin-bottom:1rem;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">Street Address <span style="color:#ef4444;">*</span></label>
<input type="text" name="affwp_w9_address" required style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
</p>

<div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
<p style="margin:0;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">City <span style="color:#ef4444;">*</span></label>
<input type="text" name="affwp_w9_city" required style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
</p>
<p style="margin:0;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">State <span style="color:#ef4444;">*</span></label>
<input type="text" name="affwp_w9_state" required maxlength="2" placeholder="CO" style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
</p>
</div>

<p style="margin-bottom:1rem;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">ZIP Code <span style="color:#ef4444;">*</span></label>
<input type="text" name="affwp_w9_zip" required maxlength="10" placeholder="80004" style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
</p>

<p style="margin-bottom:1rem;">
<label style="color:#94a3b8;display:block;margin-bottom:0.25rem;">SSN or EIN <span style="color:#ef4444;">*</span></label>
<input type="text" name="affwp_w9_tax_id" required maxlength="11" placeholder="123-45-6789 or 12-3456789" style="width:100%;background-color:#150f24;border:1px solid #1f2b47;color:#e2e8f0;padding:0.5rem;border-radius:0.375rem;box-sizing:border-box;">
...
<p style="color:#94a3b8;font-size:0.875rem;margin-bottom:1rem;"><strong style="color:#e2e8f0;">Certification</strong> &mdash; Under penalties of perjury, I certify that:</p>
...
<input type="checkbox" name="affwp_w9_certification" value="1" required style="margin-top:0.125rem;">
...
add_action('user_register', 'microdos4u_save_w9_on_register');
add_action('affwp_insert_affiliate', 'microdos4u_save_w9_on_affiliate', 10, 2);

function microdos4u_save_w9_on_register($user_id) {
    if (empty($_POST['affwp_user_login']) && empty($_POST['affwp_user_name'])) return;
    microdos4u_save_w9_data($user_id);
}

function microdos4u_save_w9_on_affiliate($affiliate_id, $data) {
    microdos4u_save_w9_data($data['user_id']);
}

function microdos4u_save_w9_data($user_id) {
    $fields = array('affwp_w9_legal_name','affwp_w9_business_name','affwp_w9_tax_classification','affwp_w9_address','affwp_w9_city','affwp_w9_state','affwp_w9_zip','affwp_w9_tax_id');
    foreach ($fields as $field) {
        if (!empty($_POST[$field])) update_user_meta($user_id, $field, sanitize_text_field($_POST[$field]));
    }
    if (!empty($_POST['affwp_w9_certification'])) update_user_meta($user_id, 'affwp_w9_certification', '1');
}
...
function microdos4u_show_w9_in_admin($affiliate) {
    ...
    $labels = array('affwp_w9_legal_name'=>'Full Legal Name','affwp_w9_business_name'=>'Business Name','affwp_w9_tax_classification'=>'Tax Classification','affwp_w9_address'=>'Street Address','affwp_w9_city'=>'City','affwp_w9_state'=>'State','affwp_w9_zip'=>'ZIP Code','affwp_w9_tax_id'=>'SSN/EIN');
    echo '<div style="margin-top:20px;padding:15px;background:#f0f0f1;border:1px solid #c3c4c7;border-radius:4px;"><h3 style="margin-top:0;">W-9 / Tax Information</h3><table class="form-table">';
    ...
    echo '<tr><th>W-9 Certification</th><td>'.($cert?'<span style="color:green;">Agreed</span>':'<span style="color:red;">Not agreed</span>').'</td></tr>';
    echo '</table></div>';
}
