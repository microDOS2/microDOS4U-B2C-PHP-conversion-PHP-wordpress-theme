...
function microdos_gravity_forms_css_fix() {
    echo '<style>
    .gform_wrapper label { color: #fff !important; }
    ...
    .gform_wrapper select { background: #e8e8e8 !important; color: #111 !important; color-scheme: light !important; border: 1px solid #888 !important; font-size: 14px !important; height: 38px !important; }
    .gform_wrapper select option { background: #fff !important; color: #111 !important; }
    .gform_wrapper select option:checked { background: #ddd !important; color: #111 !important; }
